...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "3.0.3"
  WORKING_DIRECTORY "/Users/ahmadlutfi/Downloads/FragIncRNA/FragIncRNA/build-codex/_deps/seqan3_fetch_content-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("3.0.3" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 3.0.3")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/3.0.3")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"3.0.3\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/ahmadlutfi/Downloads/FragIncRNA/FragIncRNA/build-codex/_deps/seqan3_fetch_content-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/ahmadlutfi/Downloads/FragIncRNA/FragIncRNA/build-codex/_deps/seqan3_fetch_content-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
